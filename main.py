...
from calculator import Calculator  # Ensure Calculator is defined properly
...
def calculate_and_print(a, b, operation_name):
    """Convert inputs to Decimals, execute the operation, and print the result."""
    try:
        a_decimal, b_decimal = map(Decimal, [a, b])
        command = OperationCommand(Calculator(), operation_name, a_decimal, b_decimal)  # Create an instance of Calculator
